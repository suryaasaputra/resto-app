"use strict";
(self["webpackChunkresto_app"] = self["webpackChunkresto_app"] || []).push([[337],{
...
/* harmony export */   "Z": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var sweetalert2__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(455);
/* harmony import */ var sweetalert2__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(sweetalert2__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _view_templates_templates_creator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(230);
...
var LikeButtonPresenter = {
  init: function init(_ref) {
    ...
    return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var likeButtonContainer, favoriteRestos, resto;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              likeButtonContainer = _ref.likeButtonContainer, favoriteRestos = _ref.favoriteRestos, resto = _ref.resto;
              _this._likeButtonContainer = likeButtonContainer;
              _this._resto = resto;
              _this._favoriteRestos = favoriteRestos;
              _context.next = 6;
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              _context3.next = 2;
              return _this3._favoriteRestos.getResto(id);
  ...
  _renderLike: function _renderLike() {
    ...
    this._likeButtonContainer.innerHTML = (0,_view_templates_templates_creator__WEBPACK_IMPORTED_MODULE_1__/* .createLikeRestoButtonTemplate */ .K7)();
      ...
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              _context4.next = 2;
              return _this4._favoriteRestos.putResto(_this4._resto);
  ...
  _renderLiked: function _renderLiked() {
    ...
    this._likeButtonContainer.innerHTML = (0,_view_templates_templates_creator__WEBPACK_IMPORTED_MODULE_1__/* .createUnlikeRestoButtonTemplate */ .m4)();
    var likeButton = document.querySelector('#likeButton');
      ...
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              _context5.next = 2;
              return _this5._favoriteRestos.deleteResto(_this5._resto.id);
...
var url_parser = __webpack_require__(765);
// EXTERNAL MODULE: ./src/scripts/view/pages/home.js
var home = __webpack_require__(431);
// EXTERNAL MODULE: ./src/scripts/view/pages/favorites.js
var favorites = __webpack_require__(755);
// EXTERNAL MODULE: ./src/scripts/view/pages/detail.js
var detail = __webpack_require__(272);
;// CONCATENATED MODULE: ./src/scripts/routes/route.js
...
var routes = {
  '/': home/* default */.Z,
  '/home': home/* default */.Z,
  '/favorites': favorites/* default */.Z,
  '/detail/:id': detail/* default */.Z
};
/* harmony default export */ const route = (routes);
      ...
      var _renderPage = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                url = url_parser/* default.parseActiveUrlWithCombiner */.Z.parseActiveUrlWithCombiner();
                page = route[url];
                _context.next = 4;
                return page.render();
              ...
              case 7:
                ...
                skipLinkElem.addEventListener('click', function (ev) {
                  ev.preventDefault();
