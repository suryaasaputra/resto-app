"use strict";
(self["webpackChunkresto_app"] = self["webpackChunkresto_app"] || []).push([[495],{
...
/* harmony import */ var _globals_config__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(597);
...
var Restaurants = /*#__PURE__*/function () {
  ...
  _createClass(Restaurants, null, [{
    ...
    value: function () {
      var _detailRestaurant = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(id) {
        var response, responseJson;
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
    ...
    key: "sendReview",
    value: function () {
      var _sendReview = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(review) {
        var response, responseJson;
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _context4.next = 2;
                return fetch(api_endpoint.sendReview, {
                  method: 'POST',
                  headers: {
              ...
              case 5:
                ...
                return _context4.abrupt("return", responseJson.customerReviews);
...
/* harmony default export */ const restaurants = (Restaurants);
...
/* harmony import */ var _styles_main_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(62);
